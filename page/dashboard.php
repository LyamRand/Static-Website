...
<body class="font-sans bg-[#F9FAFB] text-slate-900 flex min-h-screen">
    ...
    <aside class="w-72 bg-white flex flex-col fixed h-full border-r border-slate-100">
        ...
        <nav class="flex-1 px-4 space-y-3">
            ...
            <a href="groupes.html"
                class="flex items-center gap-4 px-6 py-4 rounded-2xl bg-surface-dark text-slate-700 font-bold hover:bg-slate-300">
                        ...
                        <div
                            ...
                            <div class="flex items-center gap-4 mb-auto">
                                <div
                                    ...
                                    ⛷️</div>
                                <div>
                                    <h4 class="text-[19px] font-black text-slate-900 leading-tight mb-0.5">Vacances Ski
                                    </h4>
                        ...
                        <div
                            ...
                            <div class="flex items-center gap-4 mb-auto">
                                <div
                                    ...
                                    ☀️</div>
                                <div>
                                    <h4 class="text-[19px] font-black text-slate-900 leading-tight mb-0.5">Voyage Sud
                                    </h4>
